      ...
      <div className="flex-col flex w-screen justify-center items-center">
        ...
        <img src={mobil1} alt="" />
          <div className="flex flex-col  -mt-10 items-center rounded-3xl bg-slate-50  ">
            <InfoM1C name={data.name} review={data.review} date={data.date} address={data.addresM1} />
            <hr
            ...
            <div className="flex flex-col w-full py-5 px-5 gap-5">
              ...
              <SelectCar />
              <OilInfo product={data.product} selected={oil} setSelect={setOil} />
              <SelectDate date={date} setDate={setDate} selectedItem={selectedItem} setSelectedItem={setSelectedItem} position={position} setPosition={setPosition} />
          ...
          <hr
            ...
            />
          <Button className="bg-[#0E479F] text-xl rounded-2xl my-10 px-28">จอง</Button>
        </div>
      </div>
      </div>
    </CustomerLayout>
